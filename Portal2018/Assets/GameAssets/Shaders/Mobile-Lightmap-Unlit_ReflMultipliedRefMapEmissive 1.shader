...
Shader "Mobile/Unlit Reflection Multipled RefMap Emissive (Supports Lightmap)" {
    Properties{
        ...
        // Fetch lightmap
            ...
            half4 skyData = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, IN.worldRefl, _Roughness);
            ...
            col.rgb += skyColor.rgb * _Tint.rgb * specResult;
            //col.rgb = fixed4(tex.a, tex.a, tex.a, 1);
            // fog
    #if USING_FOG
            col.rgb = lerp(unity_FogColor.rgb, col.rgb, IN.fog);
    #endif
            col.rgb += tex2D(_EmissiveTex, IN.uv1.xy);
        return col;
    }
    ENDCG
}
