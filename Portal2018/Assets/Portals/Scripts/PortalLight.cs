...
namespace Portals {
    ...
    public class PortalLight : MonoBehaviour {
        ...
        public int PortalDepth = 0;
        public LightShadows ShadowType { get { return _shadowType; } set { _shadowType = value; } }
        ...
        private void LateUpdate() {
            ...
            foreach (Portal portal in Portal.AllPortals) {
                PortalLight child = null;
                _children.TryGetValue(portal, out child);
