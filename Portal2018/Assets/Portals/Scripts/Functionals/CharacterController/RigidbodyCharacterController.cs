...
namespace Portals {
    ...
    public class RigidbodyCharacterController : MonoBehaviour {
        ...
        private Vector3 UpVector {
            get { return _gravityManipulator ? _gravityManipulator.upVector : Vector3.up; }
        }
        ...
        private void DoGroundCheck() {
            ...
            RaycastHit hit;
            _isGrounded = Physics.SphereCast(origin, radius, direction, out hit, distance, layerMask, QueryTriggerInteraction.Ignore);
        }
        ...
        public void ToggleNoClip() {
            ...
            if (_noClipEnabled) {
                _rigidbody.collisionDetectionMode = CollisionDetectionMode.ContinuousDynamic;   //was speculative but I don't think we've got that - Kano!
